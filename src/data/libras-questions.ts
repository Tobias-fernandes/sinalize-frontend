...
const librasQuestions: QuizQuestion[] = [
    ...
    },
    {
        id: 17,
        title: "O sinal descrito abaixo corresponde a qual palavra em Libras?",
        description: "Dedo indicador apontando para a frente e se afastando do corpo.",
        alternatives: [
            { id: "A", text: "Lá" },
            { id: "B", text: "Ir" },
            { id: "C", text: "Vir" },
    ...
    },
    {
        id: 18,
        title: "O sinal descrito abaixo corresponde a qual palavra em Libras?",
        description: "Mão aberta na lateral da cabeça com movimento de balancar para frente.",
        alternatives: [
            { id: "A", text: "Entender" },
            { id: "B", text: "Avisar" },
            { id: "C", text: "Ouvir" },
    ...
    },
    {
        ...
        title: "O sinal descrito abaixo corresponde a qual palavra em Libras?",
        description:
            "Dedos indicador e meéio unidos balancando lateralmente (movimento de negação manual).",
        alternatives: [
            { id: "A", text: "Nunca" },
            { id: "B", text: "Não" },
            { id: "C", text: "Nada" },
    ...
    },
    {
        id: 21,
        title: "O sinal descrito abaixo corresponde a qual palavra em Libras?",
        description: "Mão fechada em \"S\" balançando o pulso para frente e para trás.",
        alternatives: [
            { id: "A", text: "Pode" },
            { id: "B", text: "Certo" },
            { id: "C", text: "Sim" },
    ...
    },
    {
        id: 30,
        title: "O sinal descrito abaixo corresponde a qual palavra em Libras?",
        description: "Dedo indicador em \"L\" balancando no queixo.",
        alternatives: [
            { id: "A", text: "Beber" },
            { id: "B", text: "Àgua" },
            { id: "C", text: "Sede" },
